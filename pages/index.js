...
export default function Home() {
  ...
  return (
    <Stack boxSizing='border-box' p='0 1rem'>
      <Head>
      ...
      <Box p='4rem 2rem 0'>
        ...
        <Flex as="main" flexDirection="column" p='0.8rem 0 0'>
          <Heading as='h1' size='xl'>See Dash in action.</Heading>
          <Text fontSize='md' fontWeight='bold' mb='1rem'>Thank you for your interest in Dash Enterprise. We'll be in touch soon to schedule a demo.</Text>
        </Flex>
        ...
        <Box m='auto' color='#7E8489;' p='3.2rem 1.5rem 2rem' borderRadius='1.4rem' b='0.5px solid  #ececec;' boxShadow='4px 8px 18px 0px #D9D9D940;' maxWidth='40rem' zIndex='9999' position='relative' top='2rem' >
