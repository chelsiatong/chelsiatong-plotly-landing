...
function Home() {
  ...
  return (
    <Stack boxSizing='border-box' p='0 1rem' bg={bgColor} >
      ...
      <Box p={{ base: '4rem 2rem 0', xl: '4rem 5rem 5rem ' }}>
        ...
        <Box m='auto' ml={{ xl: '1rem' }} p='3.2rem 1.5rem 2rem' borderRadius='1.4rem' b='0.5px solid  #ececec;' boxShadow='4px 8px 18px 0px #D9D9D940;' maxWidth={{ base: '40rem', xl: '30rem' }} zIndex='9999' position='relative' top={{ base: '1.2rem', sm: '1.8rem', md: '2.7rem', xl: '-23rem' }} bg={bgColor} float={{ xl: 'right' }}>
      ...
      <Flex flexDirection={{ base: 'column', xl: 'row' }} position={{ xl: 'absolute' }} bottom={{ xl: '14rem' }} right={{ xl: '7rem' }}>
        <Box m={{ base: 'auto' }} mr={{ xl: '1rem' }}>
