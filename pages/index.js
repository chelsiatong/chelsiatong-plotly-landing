...
function Home() {
  ...
  return (
    <Stack boxSizing='border-box' p='0 1rem' bg={bgColor} m={{ xl: 'auto' }}  >
      ...
      <Box p={{ base: '4rem 2rem 0', xl: '4rem 5rem 0 5rem ' }} m={{ xl: 'auto' }} height={{ xl: '80vh' }}>
        ...
        <Box m={{ xl: '1rem' }} display={{ xl: 'block' }}  >
          ...
          <Box m={{ base: 'auto', xl: '0' }} p='3.2rem 1.5rem 2rem' zIndex='2' borderRadius='1.4rem' b='0.5px solid  #ececec;' boxShadow='4px 8px 18px 0px #D9D9D940;' maxWidth={{ base: '40rem', xl: '30rem' }} position='relative' top={{ base: '1rem', sm: '1.8rem', md: '2.7rem', xl: '-23rem' }} left={{ xl: '38rem' }} bg={bgColor} >
        ...
        <Flex flexDirection={{ base: 'column', xl: 'row' }} position={{ xl: 'relative' }} bottom={{ xl: '40rem' }} >
          <Box m={{ base: 'auto', xl: '0' }} mr={{ xl: '1rem' }} zIndex='1'>
